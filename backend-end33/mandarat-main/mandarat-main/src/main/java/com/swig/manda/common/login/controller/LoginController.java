package com.swig.manda.common.login.controller;

import com.swig.manda.auth.config.auth.PrincipalDetails;
import com.swig.manda.common.login.dto.FindUsernameRequest;
import com.swig.manda.common.login.dto.FindUserpasswordRequest;
import com.swig.manda.common.login.dto.LoginRequest;
import com.swig.manda.common.login.dto.PWupdateDto;
import com.swig.manda.common.login.repository.LoginRepository;
import com.swig.manda.common.login.service.LoginService;
import com.swig.manda.common.signup.model.Member;
import com.swig.manda.common.signup.repository.SignupRepository;
import com.swig.manda.common.login.service.SendMailService;
...
public class LoginController {
    ...
    public ResponseEntity<String> handleFindPasswordRequest(@Valid @RequestBody FindUserpasswordRequest findUserpasswordRequest) {
        ...
        boolean userExists = loginRepository.existsByUserId(username);
        if (!userExists) {
    ...
    public ResponseEntity<String> handleFindIdRequest(@Valid @RequestBody FindUsernameRequest findUsernameRequest){
        ...
        boolean nameExists = loginRepository.existsByUsername(name);
        if(!nameExists){
        ...
        String username=loginService.findUsernameByEmailAndName(email,name);
    ...
    public ResponseEntity<String> updatePassword(@Valid @RequestBody PWupdateDto pwUpdateDto, BindingResult bindingResult) {
        try {
            ...
            Optional<Member> optionalMember = loginRepository.findByUserId(pwUpdateDto.getUserId());
            ...
            loginService.updatePassword(pwUpdateDto.getUserId(), pwUpdateDto.getNewPassword());
