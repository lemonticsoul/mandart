package com.swig.manda.auth.config.oauth;
...
import com.swig.manda.common.signup.service.MemberService;
...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Optional<Member> userOptional = Optional.ofNullable(loginRepository.findByEmail(email));
